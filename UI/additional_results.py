...
def showresults():
    ...
    summaryframe = LabelFrame(
        results_window, text="Parameters of Classification", pady=10, width=250)

    Label(summaryframe, text="Classifier used:    ").grid(
        row=0, column=0, pady=10)
    Label(summaryframe, text=settings["User selected settings"]["Classifier"]).grid(
        row=0, column=1, pady=10)
    if(settings["User selected settings"]["Classifier"] == "Auto"):
        Label(summaryframe, text=results["selected classifier"]).grid(
    ...
    resultsframe = LabelFrame(
        results_window, text="Results of Classification", pady=10, width=250)
